...
/*   Updated: 2016/12/15 17:54:43 by ybenoit          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_coord		*i_coord(int x, int y, t_fdx *my_fdx)
{
	...
	my_p->x = (x * my_fdx->cte1 - my_fdx->cte2 * y) * my_fdx->zoom;
	my_p->y = (-my_fdx->my_fdf->tab[y][x]/my_fdx->cte3 + ((my_fdx->cte1 / 2) * x) + (my_fdx->cte2 / 2) * y) * my_fdx->zoom;
	return (my_p);
}
